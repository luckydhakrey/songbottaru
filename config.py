...
class Config(object):
    ...
    BLACK_IMG = getenv("BLACK_IMG", "https://graph.org/file/a405834a815962d8709dc.jpg")        # black image for progress
    BOT_NAME = getenv("BOT_NAME", "\x40\x4d\x75\x73\x69\x63\x5f\x48\x65\x6c\x6c\x42\x6f\x74")   # dont put fancy texts here.
    BOT_PIC = getenv("BOT_PIC", "https://te.legra.ph/file/bd995b032b6bd263e2cc9.jpg")           # put direct link to image here
